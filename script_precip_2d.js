$(document).ready(function() {
  ...
  var POINT_X = 'temperature'; // column name for x values in data.csv
  var POINT_X_PREFIX = ''; // prefix for x values, eg '$'
  var POINT_X_POSTFIX = ''; // postfix for x values, eg '%'

  var POINT_Y = 'precipitation'; // column name for y values in data.csv
  ...
  var X_AXIS = 'Temperature';  // x-axis label and label in tooltip
  var Y_AXIS = 'Precipitation'; // y-axis label and label in tooltip

  var SHOW_GRID = true; // `true` to show the grid, `false` to hide

  // Read data file and create a chart
  d3.csv('./precipitation_2d.csv').then(function(rows) {
